...
12. **Standalone Window Mode**: Support for launching any tool into its own dedicated desktop window. Accessed via a right-click context menu in the main sidebar.

*Tested and verified on 2026-03-08 (Added: Filtering, File Alias, Slim Resizable Sidebar, and Standalone Window Mode. Fixed: UI Pollution & ID Normalization BUG-7/8/14).*
