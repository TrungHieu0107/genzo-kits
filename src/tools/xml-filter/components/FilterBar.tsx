    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="grid grid-cols-4 gap-3">
        <div className="flex flex-col gap-1.5">
          <label className="text-[10px] text-gray-500 font-medium ml-1">Tag Name</label>
          <input
            type="text"
            value={query.tag || ''}
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[10px] text-gray-500 font-medium ml-1">Attribute Name</label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[10px] text-gray-500 font-medium ml-1">Attribute Value</label>
          <input
            type="text"
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[10px] text-gray-500 font-medium ml-1">Inner Text</label>
          <input
            type="text"
            value={query.text || ''}
