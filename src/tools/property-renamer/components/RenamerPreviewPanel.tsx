  ...
  return (
    <div className="w-[380px] flex-shrink-0 bg-[#252526]/90 backdrop-blur-xl border-l border-[#3C3C3D] flex flex-col shadow-2xl relative z-30">
      <div className="px-4 py-3 flex items-center justify-between border-b border-[#3C3C3D]/50 bg-[#2d2d2d]/30">
        <span className="text-[11px] font-black uppercase text-gray-400 truncate pr-2 tracking-widest">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar bg-[#181818]/50">
        {selectedOccurrences.length === 0 ? (
          <div className="flex items-center justify-center h-full text-gray-500 text-[11px] font-bold uppercase tracking-widest text-center px-8 italic opacity-30">
          ...
          selectedOccurrences.map((occ, i) => {
            ...
            return (
              <div key={i} className="border-b border-[#3C3C3D]/30 px-4 py-4 hover:bg-[#222]/50 transition-colors">
                <div className="flex items-center justify-between text-[10px] text-gray-500 mb-2 font-bold uppercase tracking-tighter">
                ...
                <pre className="text-[11px] font-mono bg-[#1E1E1E] rounded-lg px-3 py-2 overflow-x-auto whitespace-pre-wrap break-all border border-[#333] shadow-inner mb-2">
                ...
                {hasMapping && (
                  <div className="animate-in fade-in slide-in-from-top-1 duration-200">
                    <div className="text-[9px] text-emerald-500/70 mb-1 font-black uppercase tracking-widest pl-1">→ Potential Result</div>
                    <pre className="text-[11px] font-mono bg-[#1a2e1a] rounded-lg px-3 py-2 overflow-x-auto whitespace-pre-wrap break-all border border-emerald-500/20 shadow-lg shadow-emerald-500/5">
