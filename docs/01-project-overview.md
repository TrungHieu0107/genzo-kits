...
- Note: Enhanced Log SQL Extractor with flattened Library view, Monaco SQL Modal, a Dialect Selector, Multi-Condition Tag Filtering, and Sidebar File Aliasing (March 08, 2026). Fixed: Nested DAO extraction, SQL parameter binding, execution identity, formatting, ID normalization, and parameterless query UI pollution (BUG-4/5/6/7/8).
